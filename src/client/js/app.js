...
function updateUI(weather) {
  ...
  const weatherFuturIcon = document.getElementById("weatherFuturIcon");
  ...
  weatherFuturIcon .innerHTML = `${weather.weatherFuturIcon}`;
  ...
  futureTemp.innerHTML = `${weather.futureTemp }°C`;
